...
{
    cout << "Welcome to our simple calculator."<< endl;         // drill 4
    ...
    cout << "Use = to print your value" << endl;            // drill 5
    ...
    try
    {
        while (cin) {
            ...
            if (t.kind == 'x') 
                break;                  //  drill 2 'q' for quit CHANGED
            if (t.kind == '=')          //  drill 3 ';' for "print now" CHANGED
                cout << "=" << val << '\n';
            else
                ts.putback(t);
            val = expression();
